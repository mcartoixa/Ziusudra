namespace Ziusudra.Rencode
{
        ...
        Encoder<int>
    {
        ...
        /// <inheritdoc />
        protected override async ValueTask<int> DoReadValueAsync(IRencodeReader reader, byte header, CancellationToken cancellationToken)
        {
            if (header == CHR_INT)
            {
        ...
        /// <inheritdoc />
        protected override async ValueTask DoWriteValueAsync(IRencodeWriter writer, int value, CancellationToken cancellationToken)
        {
