namespace Ziusudra.Rencode
{
        ...
        Encoder<double>
    {
        ...
        /// <inheritdoc />
        protected override async ValueTask<double> DoReadValueAsync(IRencodeReader reader, byte header, CancellationToken cancellationToken)
        {
            if (header == CHR_FLOAT)
            {
        ...
        /// <inheritdoc />
        protected override async ValueTask DoWriteValueAsync(IRencodeWriter writer, double value, CancellationToken cancellationToken)
        {
